...
import com.pascalnb.iloc.executor.model.Instr;
import com.pascalnb.iloc.executor.model.Label;
import com.pascalnb.iloc.executor.model.Num;
import com.pascalnb.iloc.executor.model.Op;
import com.pascalnb.iloc.executor.model.OpCode;
import com.pascalnb.iloc.executor.model.OpList;
import com.pascalnb.iloc.executor.model.Operand;
import com.pascalnb.iloc.executor.model.Operand.Type;
import com.pascalnb.iloc.executor.model.Program;
import com.pascalnb.iloc.executor.model.Reg;
import com.pascalnb.iloc.executor.model.Str;
import com.pascalnb.iloc.executor.parse.ErrorListener;
import com.pascalnb.iloc.executor.parse.FormatException;
import com.pascalnb.iloc.executor.parse.ILOCBaseListener;
import com.pascalnb.iloc.executor.parse.ILOCLexer;
import com.pascalnb.iloc.executor.parse.ILOCParser;
import com.pascalnb.iloc.executor.parse.ILOCParser.CommentContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.DeclContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.InstrContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.InstrListContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.OpCodeContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.OperandContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.ProgramContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.RealOpContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.SingleInstrContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.SourcesContext;
import com.pascalnb.iloc.executor.parse.ILOCParser.TargetsContext;
